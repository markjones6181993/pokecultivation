#===============================================================================
# [009] Battle Challenge Compatibility Fix
#===============================================================================
# Fixes Battle Challenge crash when nil foe is passed to raid transition check.
# This hotfix properly removes and re-registers the animation with nil-safety.
#===============================================================================

# Remove the original registration
SpecialBattleIntroAnimations.remove("vs_raid_pokemon_animation")
...
SpecialBattleIntroAnimations.register("vs_raid_pokemon_animation", 100,
  proc { |battle_type, foe, location|
    ...
    next false if !foe || !foe.is_a?(Array) || foe.empty?
    
    # Check for wild battle (even battle_type) and single opponent
    next false if battle_type % 2 == 1 || foe.length != 1
    
    # Check if this is actually a raid battle
